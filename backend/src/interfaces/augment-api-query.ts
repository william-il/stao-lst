...
declare module '@polkadot/api-base/types/storage' {
    interface AugmentedQueries<ApiType extends ApiTypes> {
        ...
        subtensorModule: {
            ...
            > &
                QueryableStorageEntry<ApiType, []>;
            networkLastLockCost: AugmentedQuery<
                ApiType,
                () => Observable<u64>,
                []
            > &
            ...
            > &
                QueryableStorageEntry<ApiType, []>;
            networkMinLockCost: AugmentedQuery<
                ApiType,
                () => Observable<u64>,
                []
            > &
            ...
            > &
                QueryableStorageEntry<ApiType, [u16]>;
            networkRateLimit: AugmentedQuery<
                ApiType,
                () => Observable<u64>,
                []
            > &
            ...
            > &
                QueryableStorageEntry<ApiType, [u16, u16]>;
            weightsMinStake: AugmentedQuery<
                ApiType,
                () => Observable<u64>,
                []
            > &
        ...
        system: {
             ...
             **/
            inherentsApplied: AugmentedQuery<
                ApiType,
                () => Observable<bool>,
                []
            > &
