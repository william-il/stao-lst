...
TxRateLimit: u64 = 10000; // [1 @ 64,888] 1  CHANGED TO 10000
```
...
AdjustmentInterval: u16 = 10; // CHANGED FROM 255 to 10
...
ServingRateLimit: u64 = 1000; //CHANGES FROM 10 - 1000
Burn: u64 = 1_000_000_000; // 1 tao
MinBurn: u64 = 1_000_000_000; // 1 tao
MaxBurn: u64 = 100_000_000_000; // 100 tao
WeightsSetRateLimit: u64 = 100000; // 0 CHANGED TO 100,000
```
