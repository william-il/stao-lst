...
parameter_types! {
    ...
    pub BlockWeights: frame_system::limits::BlockWeights =
        frame_system::limits::BlockWeights::with_sensible_defaults(
            Weight::from_parts(16u64 * WEIGHT_REF_TIME_PER_SECOND, u64::MAX),
            NORMAL_DISPATCH_RATIO,
        );
    pub BlockLength: frame_system::limits::BlockLength = frame_system::limits::BlockLength
        ::max_with_normal_ratio(40 * 1024 * 1024, NORMAL_DISPATCH_RATIO);
...
parameter_types! {
    ...
    pub const SubtensorInitialAdjustmentInterval: u16 = 20;
    ...
    pub const SubtensorInitialMaxRegistrationsPerBlock: u16 = 10;
    ...
    pub const SubtensorInitialServingRateLimit: u64 = 1000000; // changed
    ...
    pub const SubtensorInitialTxDelegateTakeRateLimit: u64 = 1000; // 30 days at 12 seconds per block
    ...
    pub const SubtensorInitialMinLockCost: u64 = 1_000_000_000; // 1000 TAO
    pub const SubtensorInitialSubnetOwnerCut: u16 = 11_796; // 18 percent
    pub const SubtensorInitialSubnetLimit: u16 = 12;
    pub const SubtensorInitialNetworkLockReductionInterval: u64 = 14 * 7200;
    pub const SubtensorInitialNetworkRateLimit: u64 = 1_000_000_000;
